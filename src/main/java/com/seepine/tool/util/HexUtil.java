...
import com.seepine.tool.codec.Base16Codec;
 ...
 *
 * <p>参考：<a href="https://my.oschina.net/xinxingegeya/blog/287476">...</a>
 *
 * @author Looly
 * @author hutool
 */
public class HexUtil {
  ...
  public static boolean isHex(String value) {
    return Pattern.compile("^[a-fA-F0-9]+$").matcher(value).matches();
  }
  ...
  public static boolean isHexNumber(String value) {
    if (Strings.startWith(value, Strings.DASHED)) {
      // issue#2875
      return false;
    }
    int index = 0;
  ...
  public static char[] encodeHex(String str, Charset charset) {
    return encodeHex(Strings.bytes(str, charset), true);
  }
  ...
  public static String encodeHexStr(String data, Charset charset) {
    return encodeHexStr(Strings.bytes(data, charset), true);
  }
  ...
  public static String format(String hexStr) {
    ...
    for (int i = 2; i < length - 1; i += 2) {
      builder.append(Strings.BLANK).append(hexStr.charAt(i)).append(hexStr.charAt(i + 1));
    }
    return builder.toString();
  }
}
